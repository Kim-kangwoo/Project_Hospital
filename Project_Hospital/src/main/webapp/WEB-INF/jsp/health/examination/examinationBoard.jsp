...
<head>
<meta charset="UTF-8">
<title>검사, 치료 게시판 페이지</title>
	<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/minseo_css/diseaseSearch.css" />
	<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/minseo_css/health/examinationBoard.css" />
...
<body>
	...
	<article id="content">
		<div class="content-header" data-cms-content="/health/_content/title">
			<h2 class="content-title">검사/치료</h2>
		</div>
...
<script src="${pageContext.request.contextPath}/resources/js/health/examinationBoard.js"></script>
