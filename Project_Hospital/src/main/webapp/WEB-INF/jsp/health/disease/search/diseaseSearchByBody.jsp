...
<head>
<meta charset="UTF-8">
<title>질환 찾기 - 신체부위별 찾기 페이지</title>
	<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/minseo_css/diseaseSearch.css" />
	<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/minseo_css/health/diseaseSearchByBody.css" />
...
<div id="breadcrumb" class="light">
	...
	<article id="content">
		<div class="content-header" data-cms-content="/health/_content/title">
			<h2 class="content-title">신체부위별 찾기</h2>
		</div>
...
<script src="${pageContext.request.contextPath}/resources/js/health/diseaseSearchByBody.js"></script>
