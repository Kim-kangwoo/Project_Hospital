...
<head>
<meta charset="UTF-8">
<title>질환 찾기 통합 검색 페이지</title>
	<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/minseo_css/diseaseSearch.css" />
	<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/minseo_css/health/diseaseSearch.css" />
...
<script src="${pageContext.request.contextPath}/resources/js/health/diseaseSearch.js"></script>
