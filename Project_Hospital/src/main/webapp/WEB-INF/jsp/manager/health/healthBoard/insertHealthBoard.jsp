...
<div class="body_wrap">
		...
		<div class="content">
			<div class="top_bar bg_w">
				<a href="#" class="top_left doctor_con"><span>건강 게시글 등록</span></a>
				<!-- 탑바 right 컨텐츠-->
				<%@ include file="WEB-INF/../../../../common/topbarContent.jspf"%>
			</div>
			<div class="con_wrap bg_13">
				<!-- content시작 -->
				<form action="insertHealthBoard" id="healthBoardInsertForm" method="post" enctype="multipart/form-data">
					<div class="doctor">
						<div class="doc_center bg_w">
							<div class="doc_con" id="nameBox">
								<p class="f_s17 f_w500">건강 게시글 제목</p>
								<input type="text" placeholder="건강 게시글 제목의 제목을 입력해주세요." id="title" name="title">
							</div>
							<div class="doc_con">
							...
							<div class="doc_con">
								...
								<textarea name="content" id="contentInput" placeholder="건강 정보에 대한 내용을 입력해주세요."></textarea>
							</div>
	...
	submitBtn.addEventListener('click', function(event) {
		...
		if (isValid) {
			if(confirm("게시글을 등록하시겠습니까?")) {
				console.log("제출");
				let form = document.getElementById("healthBoardInsertForm");
				form.submit();
			} else {
				return;
			}
