...
public class DoctorInfoDTO {
	...
	public List<String> getFilestoreId() {
		return filestoreId;
	}
	public void setFilestoreId(List<String> filestoreId) {
	...
	public String toString() {
		return "DoctorInfoDTO [drId=" + drId + ", drPw=" + drPw + ", deptId=" + deptId + ", drPosition=" + drPosition
				+ ", drName=" + drName + ", drPhoneNum=" + drPhoneNum + ", drAddress=" + drAddress + ", drField="
				+ drField + ", drEducation=" + drEducation + ", drCareer=" + drCareer + ", drAcademic=" + drAcademic
				+ ", drAwards=" + drAwards + ", drPersonNum=" + drPersonNum + ", fileone=" + fileone + ", filetwo="
				+ filetwo + ", filethree=" + filethree + ", deptName=" + deptName + ", filestoreId=" + filestoreId
