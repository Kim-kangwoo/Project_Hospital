...
public class HpMemberScheduleDTOBackup {
	...
	public HpMemberScheduleDTOBackup() {
		super();
	}


	public HpMemberScheduleDTOBackup(List<String> amOtIdList, String amStatus, List<String> pmOtIdList, String pmStatus,
