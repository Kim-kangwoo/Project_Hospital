...
public class OpeningTimeServiceImpl implements OpeningTimeService {
	 ...
	 */
	@Override
	public void insertSchedule(String timeType, String insertStatus, String date, String drId) {
		
		Map<String, Object> optionMap = new HashMap<String, Object>();
		optionMap.put("timeType", timeType);
	...
	@Override
	public void updateSchedule(String timeType, String updateStatus, String date, String drId) {
